   ...
   public class Main {
       public static void main(String[] args) throws IOException {
           ...
           while (true) {
               ...
               if (option == 1) {
                   File file = new File("C:\\phase1filescheck" );
                   ...
                   switch (input) {
                       case 1:
                           ...
                           File file = new File("C:\\phase1filescheck\\" + name);
                       ...
                       case 2:
                           ...
                           File file1 = new File("C:\\phase1filescheck\\" + name1);
                           if(file1.delete())
                       ...
                       case 3:
                           ...
                           File file2 = new File("C:\\phase1filescheck\\" + fileName);
                           if( file2.exists())
                           {
               ...
               if (option == 3){
            	   System.out.println("Process finished with exit code 3");
                   System.exit(option);
